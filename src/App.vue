...
<template>
  <div class="app-shell" :class="{ 'public-shell': publicRoute }">
    ...
    <aside v-if="!publicRoute" class="rail">
      ...
      <div class="foot"><div class="kv"><span>UI</span><b>0.2.3</b></div><div class="kv"><span>Context</span><b>{{ state.contextSource }}</b></div><div class="kv"><span>Auth</span><b :class="state.authStatus === 'verified' ? 'oktxt' : (state.authStatus === 'verifying' ? 'warntxt' : 'dangertext')">{{ accountStatus }}</b></div></div>
    </aside>
